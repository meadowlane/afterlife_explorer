          ...
          >
            {filteredRealms.map((realm) => (
              ...
              >
                ...
                <p className="font-sans text-sm text-[var(--color-warm-muted)] leading-relaxed">
        ...
        {selectedRealm && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
            ...
            <motion.div
              ...
              className="bg-[#fcfcfb] w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-[32px] shadow-2xl relative z-10"
            >
              <div className="p-8 md:p-12">
                <button
